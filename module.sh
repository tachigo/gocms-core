...
ASSEMBLY_FILE="${PROJECT_ROOT}/src/internal/cmd/assembly.go"
...
update_assembly() {
    local module="$1"
    local import_line="_ \"github.com/tachigo/gocms-core/src/internal/module/$module\""
    ...
    local awk_cmd="/import \\(/ { print; print \"    _ \\\"gocms/internal/module/$module\\\"\"; next } { print }"
...
cmd_link() {
    ...
    mkdir -p "${PROJECT_ROOT}/src/internal/module"
